...
public class ConversationDao extends AbstractDao<Conversation, Long> {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CONVERSATION\" (" + //
                ...
                "\"RECIPIENT\" TEXT," + // 2: recipient
                "\"CONTACT_ID\" TEXT);"); // 3: contactId
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Conversation entity) {
        ...
        if (recipient != null) {
            stmt.bindString(3, recipient);
        }
 
        String contactId = entity.getContactId();
        if (contactId != null) {
            stmt.bindString(4, contactId);
        }
    }
    ...
    public Conversation readEntity(Cursor cursor, int offset) {
        Conversation entity = new Conversation( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // recipient
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3) // contactId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Conversation entity, int offset) {
        ...
        entity.setRecipient(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        entity.setContactId(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
     }
